        ...
        showProducts: function (s) {
          let r = t("<form>").attr({
            ...
            d = t("<span>")
              ...
              .html("Ціна за 1 товар чи послугу")
              .append(p),
            u = t("<div>")
          ...
          let m = t("<div>")
              ...
              .html(`Ціна разом / ${a.smartBasketCurrency}`),
            k = t("<div>")
              .attr({ class: "smart-basket__product-delete" })
              .text("Видалити");
          ...
          for (let n in s) {
            ...
            for (let a in s[n]) {
              if (
                ...
                let e = t("<img>").attr({ src: s[n][a], width: 100 });
          ...
          return (
            ...
            c.click(function () {
              ...
              if (void 0 !== r[n]) {
                let a = t(this).html();
                return (
                  t(this).text("Товар вже у кошику"),
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            ...
            l = t("<div>")
              ...
              .text("Замовлення прийнято. Очікуйте на дзвінок менеджера")
              .css("display", "none"),
        ...
        userForm: function () {
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            (r = a.agreement.isLink
              ...
              s.is(":checked")
                ? r.text("Я приймаю умови користувальницької угоди")
                : r.text("Я не приймаю умови користувальницької угоди"),
              e.click(function () {
                s.is(":checked")
                  ? (r.text("Я не приймаю умови користувальницької угоди"),
                    s.val("Я не приймаю умови користувальницької угоди"),
                    m.attr({ disabled: "disabled" }),
                    d.addClass("smart-basket__input-wrapper_error"))
                  : (r.text("Я  приймаю умови користувальницької угоди"),
                    s.val("Я  приймаю умови користувальницької угоди"),
                    m.attr({ disabled: !1 }),
